...
namespace RR.Infraestructure.Migrations
{
    ...
    [Migration("20260106015248_AddEquipmentReservations")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RR.Core.Entities.EquipmentReservation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("CreatedAt")
                        .HasDatabaseName("ix_equipment_reservations_created_at");

                    b.HasIndex("EquipmentId")
                        .HasDatabaseName("IX_EquipmentReservations_EquipmentId");

                    b.HasIndex("IsActive")
                        .HasDatabaseName("ix_equipment_reservations_is_active");
                    ...
                    b.HasIndex("EquipmentId", "StartTime", "EndTime", "Status")
            ...
            modelBuilder.Entity("RR.Core.Entities.RoomEquipment", b =>
                {
                    ...
                    b.HasIndex("CreatedAt")
                        .HasDatabaseName("ix_room_equipments_created_at");

                    b.HasIndex("EquipmentId")
                        .HasDatabaseName("IX_RoomEquipments_EquipmentId");

                    b.HasIndex("IsActive")
                        .HasDatabaseName("ix_room_equipments_is_active");
            ...
            modelBuilder.Entity("RR.Core.Entities.EquipmentReservation", b =>
                {
                    ...
                    b.HasOne("RR.Core.Entities.Reservation", "RoomReservation")
                        .WithMany()
